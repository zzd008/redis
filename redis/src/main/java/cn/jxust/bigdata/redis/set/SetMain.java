package cn.jxust.bigdata.redis.set;
...
public class SetMain {
    ...
    public static void main(String[] args) {
        ...
        //创建并设置一个set的值
        jedis.sadd("biwu:dengji", daxias);//可以放数组，重复的元素不会被放进去
        //获取一个set中所有的元素
        ...
        // jedis.sinterstore("aa",biwu:dengji", "guoji:dengji");去交集并保存为新的set
        ...
        jedis.srem("vipdaxia", "东方不败");//删除vip中的东方不败
        Set<String> vipSet = jedis.smembers("vipdaxia");
        for(String s:vipSet){
        	System.out.print(s + " ");
        }
